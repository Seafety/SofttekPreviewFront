...
import {
  ...
  custoOptions,
  Bar,
} from "../../../Components/Organisms/ChartOptions";
  ...
  const data = {
    ...
    datasets: [
      ...
      },
      {
        label: "Fev",
        data: [
          21.84, 10.92, 14.56, 18.2, 21.84, 9.1, 12.74, 9.1, 10.92, 7.28, 14.56,
          7.28, 7.28, 5.46, 7.28, 3.64,
        ],
      ...
      },
      {
        ...
        data: [
          56.89, 28.44, 37.93, 47.41, 56.89, 23.7, 33.19, 23.7, 28.44, 18.96,
          37.93, 18.96, 18.96, 14.22, 18.96, 9.48,
        ],
        type: "line",
        borderColor: "#52A1E9",
        yAxisID: "y-axis-2",
    ...
    datasets: [
      {
        ...
        data: [
          21.117, 11.252, 14.065, 16.878, 21.098, 10.383, 11.252, 7.033, 9.846,
          7.033, 11.252, 7.033, 4.22, 4.22, 7.033, 8.439,
        ],
        backgroundColor: "#6349FF",
        borderRadius: 2.5,
        barThickness: 10,
      ...
      },
      {
        label: "Projeção futura",
        data: [
          24.285, 12.94, 16.175, 19.41, 24.262, 11.94, 12.94, 8.087, 11.322,
          8.087, 12.94, 8.087, 4.852, 4.852, 8.087, 9.705,
        ],
        type: "line",
        borderColor: "#52A1E9",
        yAxisID: "y-axis-2",
    ...
    [
      {
        ...
        status: "available",
        role: "estagiario",
        tooltip: "Consultor estagiário disponível",
      },
      {
        date: 2,
        status: "unavailable",
        role: "estagiario",
        tooltip: "Consultor estagiário indisponível",
      },
      {
        date: 3,
        status: "available",
        role: "",
        tooltip: "Consultor júnior disponível",
      },
      {
        date: 4,
        status: "unavailable",
        role: "junior",
        tooltip: "Consultor júnior indisponível",
      },
      {
        date: 5,
        status: "available",
        role: "",
        tooltip: "Consultor pleno disponível",
      },
      {
        date: 6,
        status: "available",
      ...
      },
      {
        ...
        status: "unavailable",
        role: "",
        tooltip: "Consultor sênior indisponível",
      },
    ],
    [
      {
        ...
        status: "unavailable",
        role: "expert",
        tooltip: "Consultor expert indisponível",
      },
      {
        date: 9,
        status: "available",
        role: "expert",
        tooltip: "Consultor expert disponível",
      },
      {
        date: 10,
        status: "available",
      ...
      },
      {
        ...
        status: "available",
        role: "senior",
        tooltip: "Consultor sênior disponível",
      },
      {
        date: 12,
        status: "unavailable",
        role: "",
        tooltip: "Consultor pleno indisponível",
      },
      {
        date: 13,
        status: "available",
